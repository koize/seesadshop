    ...
    <div class="container">
      <section class="text-center">
        <?php 
          if (isset($_GET['search_products'])) {
            ...
            echo '<h6 class="my-5 display-6 fw-bold ls-tight" style="color: #2980B9">
            Our
            <span style="color: #6DD5FA">products - Others</span>
          </h6>';
          }
      ...
      products_category TEXT
        ...
        if (isset($_GET['search_products'])) {
          ...
          $sql = "SELECT id,image_link,product_name,product_desc,product_price FROM products WHERE products_category='Others'";
        }
